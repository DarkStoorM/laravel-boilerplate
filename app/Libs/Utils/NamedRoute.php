...
class NamedRoute
{
    ...
    /** This is the route that displays the results of Password Reset Token validation. Note: this is not the results page displayed when user changes his password. @see GET_PASSWORD_RESET_CHANGE_RESULT */
