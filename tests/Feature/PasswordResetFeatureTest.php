...
class PasswordResetFeatureTest extends TestCase
{
    ...
    public function testCanSendPasswordResetLinks(): void
    {
        $this->assertGuest()
    ...
    public function testCantSendPasswordResetLinksWithInvalidEmail(): void
    {
        $this->assertGuest()
     ...
     */
    public function testCanThrottlePasswordResetRequests(): void
    {
     ...
     */
    public function testUserWillNotSeePasswordChangeFormWithInvalidToken(): void
    {
        $token = PasswordReset::GenerateAndInsert($this->user->email);
        $invalidData = [
    ...
    public function testAuthenticatedUserCantSubmitPasswordChangeForm(): void
    {
        $token = PasswordReset::GenerateAndInsert($this->user->email);
        ...
        $this->actingAs($this->user)
            ...
            ->post(
                route(
                    NamedRoute::POST_PASSWORD_RESET_CHANGE_STORE,
     ...
     */
    public function testUnauthenticatedUserCanSubmitPasswordChangeForm(): void
    {
        $token = PasswordReset::GenerateAndInsert($this->user->email);
    ...
    public function testUserCantChangePasswordWithInvalidData(): void
    {
        $token = PasswordReset::GenerateAndInsert($this->user->email);
        $passwordCases = [
            ['', ''],
     ...
     */
    public function testUserCantChangePasswordWithMalformedData(): void
    {
        $token = PasswordReset::GenerateAndInsert($this->user->email);
     ...
     */
    public function testUserCanChangePasswordAndInvalidateRequestedToken(): void
    {
        $token = PasswordReset::GenerateAndInsert($this->user->email);
        $this->assertDatabaseHas('password_resets', ['token' => $token->token]);
